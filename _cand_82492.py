import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.157, "reserve_ratio_late": 0.414, "leader_bonus": 1.723, "enemy_bonus": 0.915, "comet_bonus": 1.256, "prod_weight": 1.953, "inbound_thresh": 0.928, "overshoot": 3}'
import math
import os
import json
