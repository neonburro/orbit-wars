import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.25, "reserve_ratio_late": 0.398, "leader_bonus": 1.063, "enemy_bonus": 0.437, "comet_bonus": 0.335, "prod_weight": 1.036, "inbound_thresh": 0.916, "overshoot": 4}'
import math
import os
import json
