import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.26, "reserve_ratio_late": 0.237, "leader_bonus": 1.059, "enemy_bonus": 1.138, "comet_bonus": 0.318, "prod_weight": 2.092, "inbound_thresh": 0.95, "overshoot": 3}'
import math
import os
import json
