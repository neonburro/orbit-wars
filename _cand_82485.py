import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.144, "reserve_ratio_late": 0.191, "leader_bonus": 0.782, "enemy_bonus": 0.466, "comet_bonus": 1.308, "prod_weight": 1.11, "inbound_thresh": 0.599, "overshoot": 3}'
import math
import os
import json
