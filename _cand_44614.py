import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.272, "reserve_ratio_late": 0.184, "leader_bonus": 0.839, "enemy_bonus": 0.75, "comet_bonus": 1.441, "prod_weight": 2.281, "inbound_thresh": 0.717, "overshoot": 1}'
import math
import os
import json
