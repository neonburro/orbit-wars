import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.052, "reserve_ratio_late": 0.209, "leader_bonus": 0.773, "enemy_bonus": 0.145, "comet_bonus": 0.069, "prod_weight": 1.434, "inbound_thresh": 0.962, "overshoot": 1}'
import math
import os
import json
