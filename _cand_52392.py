import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.226, "reserve_ratio_late": 0.315, "leader_bonus": 1.815, "enemy_bonus": 0.093, "comet_bonus": 0.971, "prod_weight": 0.978, "inbound_thresh": 0.731, "overshoot": 1}'
import math
import os
import json
