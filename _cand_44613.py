import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.162, "reserve_ratio_late": 0.242, "leader_bonus": 0.066, "enemy_bonus": 0.576, "comet_bonus": 1.313, "prod_weight": 2.194, "inbound_thresh": 0.752, "overshoot": 1}'
import math
import os
import json
