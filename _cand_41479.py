import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.218, "reserve_ratio_late": 0.33, "leader_bonus": 1.415, "enemy_bonus": 0.746, "comet_bonus": 0.904, "prod_weight": 0.8, "inbound_thresh": 0.659, "overshoot": 2}'
import math
import os
import json
