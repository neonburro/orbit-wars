import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.2, "reserve_ratio_late": 0.4, "leader_bonus": 1.6, "enemy_bonus": 0.9, "comet_bonus": 0.6, "prod_weight": 1.0, "inbound_thresh": 0.85, "overshoot": 4}'
import math
import os
import json
