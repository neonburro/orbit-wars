import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.338, "reserve_ratio_late": 0.359, "leader_bonus": 0.071, "enemy_bonus": 0.749, "comet_bonus": 0.64, "prod_weight": 1.331, "inbound_thresh": 0.776, "overshoot": 2}'
import math
import os
import json
