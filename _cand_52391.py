import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.322, "reserve_ratio_late": 0.201, "leader_bonus": 0.102, "enemy_bonus": 1.078, "comet_bonus": 0.474, "prod_weight": 0.978, "inbound_thresh": 0.708, "overshoot": 2}'
import math
import os
import json
