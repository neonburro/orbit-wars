import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.307, "reserve_ratio_late": 0.316, "leader_bonus": 0.419, "enemy_bonus": 0.882, "comet_bonus": 0.326, "prod_weight": 1.64, "inbound_thresh": 0.75, "overshoot": 2}'
import math
import os
import json
