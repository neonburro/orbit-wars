import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.341, "reserve_ratio_late": 0.288, "leader_bonus": 0.553, "enemy_bonus": 0.34, "comet_bonus": 1.114, "prod_weight": 2.365, "inbound_thresh": 0.843, "overshoot": 4}'
import math
import os
import json
