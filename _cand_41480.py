import json, os
os.environ['OW_PARAMS'] = '{"reserve_ratio": 0.09, "reserve_ratio_late": 0.245, "leader_bonus": 1.018, "enemy_bonus": 1.089, "comet_bonus": 0.711, "prod_weight": 1.531, "inbound_thresh": 0.712, "overshoot": 4}'
import math
import os
import json
